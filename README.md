...
```mermaid
graph TD
 A([Начало]) --> B[/Ввести целые a,b,c,d/]
 B --> D[/Ввести x/]
 D --> F{a1<= b1}
 ...
 K5 -- "Да" --> P3[/'c d' lett1 имеют одинаковый остаток. Изнач число: mn/]
 K5 -- "Нет" --> P4[/lett1 lett2 имеют одинаковый остаток. Изнач число: mn/]
 K1 -- "Нет" --> K7{equals=true}
 K7 -- "Да" --> P7[/'a b' имеют одинак остаток. Изнач число: a/]
 K7 -- "Нет" --> P8[/lett1 имеет мин остаток. Изнач число: mn/]
 K -- "Нет" --> K9{equals==true}
 K9 -- "Да" --> P9[/'c d' имеют мин остаток. Изнач число: c/]
 K9 -- "Нет" --> P10[/lett2 имеет мин остаток. Изнач число: mn/]
 P1 --> Z([Конец])
 P2 --> Z
 P3 --> Z
 P4 --> Z
